...
const MERAK_TR = [
  {key: 'herkes-yasiyor', kime: 'bunu yaşayan tek kişi olduğunu sanan arkadaşına', aile: 'merak',
    focus: 'HERKES YAŞIYOR GAFI: kapı — "sadece bende mi oluyor" diye içinden geçirdiği an, izleyicinin kendi hissi (yalnızlık duygusu) — yaygınlık İDDİASI değil, "sadece bende mi diye düşündüğün an" duygusu. Anlatılan mekanizma bugünkü konudan gelir — twist yeni bir mekanizma İDDİA ETMEZ, sadece bu mekanizmayı KİME anlattığını değiştirir. ⛔ YASAK: sayısız yaygınlık iddiası (herkeste olur / hepimiz yaşıyoruz gibi genellemeler), mekanizmayı doğrulamak için bir deney yapıldığı izlenimi vermek, uydurma istatistik ("kadınların yüzde doksanı"), ilişki-kişilik psikolojisi. ✅ böyle: "sekiz saat uyuyup yine de bitkin uyanan o sen değilsin, uyku iki evreden geçiyor ve biri seni hiç dinlendirmiyor" (davranış + bugünkü mekanizma). ⛔ böyle değil: "araştırmalar kadınların çoğunun bunu yaşadığını gösterdi" (uydurma istatistik, kaynaksız iddia).'},
